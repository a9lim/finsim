...
export const MARKET_EVENTS = [
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 0.6,
        headline: 'DOJ files antitrust suit against three major cloud providers alleging market allocation; enterprise AI contracts could be voided. The Meridian Brief: "If these contracts unwind, Atlas Crucible is the biggest beneficiary — or the biggest casualty."',
        magnitude: 'moderate',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.0,
        headline: 'TSMC warns of 16-week lead times on advanced nodes; AI chip allocations cut 30%. Malhotra on the Atlas Crucible investor call: "We\'re exploring alternative sourcing." The Meridian Brief flags unusual options activity ahead of the announcement.',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.8,
        headline: 'Gartner raises enterprise cloud spending forecast 20%; AI workloads driving "unprecedented demand." The Meridian Brief: "Atlas Crucible is the picks-and-shovels play. Malhotra knows it."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 0.8,
        headline: 'Zhaowei\'s Qilin-4 model tops Atlas Sentinel on three major AI benchmarks; Liang Wei: "The gap is closed." Kassis questions the methodology publicly. Sharma: "Benchmark wars are marketing. Crucible revenue is reality."',
        magnitude: 'moderate',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.5,
        headline: 'Zhaowei CEO Liang Wei keynotes Nanjing AI Summit; announces state-backed $50B compute buildout. Dirks calls it "a Sputnik moment for Columbian AI." The Meridian Brief: "Crucible just got a competitor with a sovereign balance sheet."',
    ...
    // -- Positive tech / AI tailwinds -----------------------------------------
    {
        ...
        category: 'sector',
        likelihood: 0.8,
        headline: 'Congress passes bipartisan $200B "American AI Leadership Act"; mandates federal agencies adopt AI platforms within 3 years. Dirks calls it "the most important legislation for Palanthropic since our founding." Atlas Sentinel and Crucible seen as primary beneficiaries.',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.5,
        headline: 'McKinsey raises AI enterprise adoption forecast for third time this year; now projects 80% of Fortune 500 will deploy by year-end. Malhotra quotes the report on the Atlas Crucible investor call: "Faster than mobile, faster than cloud."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.0,
        headline: 'TSMC breaks ground on $40B U.S. fab; AI chip supply constraints easing as industry invests record $150B in new capacity. The Meridian Brief: "Good news for Atlas Crucible margins. Lead times finally improving."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.2,
        headline: 'AI venture funding hits $80B in a single quarter, shattering all records. Sharma on MarketWire: "Every pitch deck has AI in it. Most of them are running on Atlas Crucible."',
    ...
    },
    {
        ...
        category: 'sector',
        likelihood: 1.5,
        headline: 'Big Tech collectively guides AI capex up 60% next year; hyperscalers in an "arms race" for compute. Malhotra schedules a special Atlas Crucible investor call. The Meridian Brief: "Infrastructure is the new oil."',
